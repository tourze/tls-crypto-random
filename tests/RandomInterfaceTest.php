 ...
 * @internal
 */
#[CoversClass(RandomInterface::class)]
final class RandomInterfaceTest extends TestCase
{
    ...
    public function testImplementsRandomInterface(): void
    {
        $this->assertInstanceOf(RandomInterface::class, $this->random);
    }

    public function testGetRandomBytesMethodSignature(): void
    {
    ...
    public function testGetRandomIntMethodSignature(): void
    {
        $reflection = new \ReflectionClass($this->random);
    ...
    public function testGetRandomBytesContractCompliance(): void
    {
    ...
    public function testGetRandomIntContractCompliance(): void
    {
    ...
    public function testInterfaceIsUsableAsTypeHint(): void
    {
        // 测试接口可以作为类型提示使用
        $this->assertInstanceOf(RandomInterface::class, $this->random);

        // 测试可以通过接口类型调用方法
        $bytes = $this->random->getRandomBytes(10);
        $int = $this->random->getRandomInt(1, 10);
