...
class CryptoRandomTest extends TestCase
{
    ...
    public function test_getRandomBytes_withValidLengths(): void
    {
        // 测试生成不同长度的随机字节
    ...
    public function test_getRandomBytes_withInvalidLength_throwsException(): void
    {
    ...
    public function test_getRandomInt_withValidRanges(): void
    {
        // 测试不同范围的随机整数
        $ranges = [
            [0, 10],
    ...
    public function test_getRandomInt_distributionInRange(): void
    {
    ...
    public function test_getRandomBytes_uniqueness(): void
    {
        // 测试多次生成的随机字节的唯一性
        $length = 16;
        $samples = [];
    ...
    public function test_getRandomInt_uniqueness_inLargeRange(): void
    {
        // 在较大范围内测试随机整数的唯一性
        $min = 1;
        $max = 1000;
    ...
    public function test_cryptographic_quality_basicEntropy(): void
    {
        // 基本的熵质量测试
    ...
    public function test_performance_largeRandomBytes(): void
    {
        // 性能测试：生成大量随机字节
    ...
    public function test_concurrent_usage_simulation(): void
    {
        // 模拟并发使用场景
        $results = [];
